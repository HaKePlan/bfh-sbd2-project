...
libraries <- c('readr', 'dlookr', 'dplyr', 'knitr', 'kableExtra')
...
17. **Status**: Binary variable indicating the loan status, where 0 represents one category and 1 represents another. The mean suggests that approximately 12.85% of loans fall into the category represented by 1.
